...
public class Server {
    ...
    /**В классе Handler происходит обмен сообщениями с клиентом **/
    private static class Handler extends Thread {
                ...
                if (message.getType() == MessageType.USER_NAME) {
                    ...
                    if (message.getData() != null && !message.getData().isEmpty()) {
                        ...
                        if (connectionMap.get(message.getData()) == null) {
                            ...
                            // Добавляем нового пользователя и соединение с ним в connectionMap
                            connectionMap.put(message.getData(), connection);
                            // Отправляем клиенту команду информирующую, что его имя принято
        ...
        private void serverMainLoop(Connection connection, String userName) throws IOException, ClassNotFoundException {
            ...
            while (true) {
                ...
                //    ConsoleHelper.writeMessage("voice transmitter");
